                ...
                <div className="border border-slate-200 rounded-xl p-3 flex justify-between items-center">
                  <div>
                    ...
                    <span className="text-xs font-bold text-slate-800">
                      https://bdretailers.com/{(selectedShop.subdomainSlug || selectedShop.shopSlug)}/privacy-policy
                    </span>
                  </div>
                  <button onClick={() => handleCopy(`https://bdretailers.com/${(selectedShop.subdomainSlug || selectedShop.shopSlug)}/privacy-policy`, 'privacy')} className="text-purple-600 font-bold hover:underline shrink-0">কপি</button>
                </div>
              </div>
