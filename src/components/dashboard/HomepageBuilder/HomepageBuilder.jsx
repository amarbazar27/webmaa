...
const DEFAULT_SECTIONS = [
  { id: 'basic_storefront', type: 'basic_storefront', enabled: true, order: 0, isPinned: true, data: { showDesc: true, showSearch: true, showCategories: true, showProducts: true, allowPhotoOrder: false, aiVisionEnabled: false } },
  { id: 'hero', type: 'hero_carousel', enabled: false, order: 1, data: { slides: [] } },
  { id: 'trust_strip', type: 'trust_strip', enabled: false, order: 2, data: {} },
  { id: 'categories', type: 'category_scroller', enabled: false, order: 3, data: { items: [] } },
  { id: 'split_showcase', type: 'split_showcase', enabled: false, order: 4, data: {} },
  { id: 'flash_sale', type: 'flash_sale', enabled: false, order: 5, data: { endTime: null, productIds: [] } },
  { id: 'product_grid', type: 'product_grid', enabled: false, order: 6, data: { title: 'আমাদের জনপ্রিয় পণ্যসমূহ', tabs: ['all', 'trending', 'bestseller'], maxProducts: 12 } },
  ...
  { id: 'photo_reviews', type: 'photo_reviews', enabled: false, order: 17, data: { reviews: [] } },
