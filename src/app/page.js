           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
              ...
              <div className="space-y-4">
                 <div className="flex items-center gap-3">
                   ...
                   />
                   <div>
                     <h3 className="text-base font-black text-white tracking-tight">{globalConfig?.brandName || 'BDRetailers'}</h3>
                     <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">bdretailers.com</p>
                   </div>
                 </div>
                 <p className="text-xs text-white/50 leading-relaxed max-w-sm font-bold">
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {(() => {
                      ...
                      return (
                        <>
                          <a href={`mailto:${rawEmail}`} className="flex items-center gap-2 text-slate-400 hover:text-purple-400 group transition-colors cursor-pointer">
                            <Bot size={14} className="group-hover:text-purple-400 text-purple-500" />
                            <span className="text-sm font-bold group-hover:text-slate-200 transition-colors">{rawEmail}</span>
                          </a>
                          <a href={`https://wa.me/${formattedWa}`} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-slate-400 hover:text-emerald-400 group transition-colors cursor-pointer">
                            <Phone size={14} className="group-hover:text-emerald-400 text-emerald-500" />
                  ...
                  <div className="flex gap-3 flex-wrap pt-4">
                    {(() => {
                      ...
                      return (
                        <>
                          {fbLink && (
                            <a href={fbLink} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 text-slate-400 hover:text-white hover:scale-110 transition-all duration-300 shadow-lg cursor-pointer">
                          ...
                          {instaLink && (
                            <a href={instaLink} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gradient-to-br hover:from-pink-600 hover:to-orange-500 hover:border-pink-600 text-slate-400 hover:text-white hover:scale-110 transition-all duration-300 shadow-lg cursor-pointer">
                          ...
                          {ytLink && (
                            <a href={ytLink} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-red-600 hover:border-red-600 text-slate-400 hover:text-white hover:scale-110 transition-all duration-300 shadow-lg cursor-pointer">
                              <svg viewBox="0 0 24 24" className="w-4.5 h-4.5 fill-current"><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>
                            </a>
                          )}
                          {waLink && (
                            <a href={waLink} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-600 hover:border-emerald-600 text-slate-400 hover:text-white hover:scale-110 transition-all duration-300 shadow-lg cursor-pointer">
                              <svg viewBox="0 0 24 24" className="w-4.5 h-4.5 fill-current"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z"/></svg>
                            </a>
                          )}
                        </>
                      );
