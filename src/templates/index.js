...
export const TEMPLATES = {
  ...
  'luxury-couture': {
    ...
    defaultTheme: {
      ...
      bgColor:        '#FAFAF8',
      textColor:      '#1C1917',
      headerBg:       'linear-gradient(135deg, #1C1917, #2D2015)',
      headerText:     '#D4AF37',
      cardBg:         '#FFFFFF',
  ...
  'luxury-dark-gold': {
    ...
    defaultTheme: {
      ...
      bgColor:        '#FDF8F0',
      textColor:      '#1C1917',
      headerBg:       'linear-gradient(135deg, #1C1917, #2C1A00)',
      headerText:     '#D4AF37',
      cardBg:         '#FFFFFF',
  ...
  'tech-gadget-hub': {
    ...
    defaultTheme: {
      ...
      headerText:     '#FFFFFF',
      cardBg:         '#FFFFFF',
      cardBorder:     'rgba(21, 101, 192, 0.15)',
      buttonRadius:   '50px',
      cardRadius:     '16px',
      fontFamily:     '"Montserrat", "Outfit", sans-serif',
      fontSize:       'base',
  ...
  'modern-glass': {
    ...
    defaultTheme: {
      ...
      bgColor:        '#F8FAFC',
      textColor:      '#0F172A',
      headerBg:       'linear-gradient(135deg, #0F172A, #16A34A)',
      headerText:     '#FFFFFF',
  ...
  'ai-futuristic': {
    ...
    defaultTheme: {
      ...
      bgColor:        '#020617',
      textColor:      '#F0F9FF',
      headerBg:       'linear-gradient(135deg, #0F172A, #0F172A)',
      headerText:     '#E0E7FF',
  ...
  'modern-commerce': {
    ...
    defaultTheme: {
      ...
      fontFamily: '"Outfit", sans-serif', fontSize: 'base', shadow: 'md',
  ...
  'apple-minimal': {
    ...
    defaultTheme: {
      ...
      fontFamily:     '"Outfit", sans-serif', fontSize: 'lg', shadow: 'sm',
...
export const getTemplateById = (id) => {
  ...
  if (typeof id === 'string' && (id.startsWith('ai-single-') || id.includes('single') || id.includes('spotlight'))) {
    return {
      ...
      defaultTheme: {
        ...
        fontFamily: '"Outfit", "Outfit", sans-serif', fontSize: 'base', shadow: 'lg',
  ...
  if (typeof id === 'string' && (id.startsWith('ai-split-') || id.includes('split'))) {
    return {
      ...
      defaultTheme: {
        ...
        fontFamily: '"Montserrat", "Outfit", sans-serif', fontSize: 'base', shadow: 'md',
  ...
  return TEMPLATES['grocery-fresh-bazaar'] || TEMPLATES['bold-commerce'] || {
    ...
    namebn: 'বোল্ড কমার্স',
    defaultTheme: {
      primaryColor: '#0F172A', secondaryColor: '#16A34A', accentColor: '#F59E0B',
      ...
      fontFamily: 'Outfit, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', fontSize: 'base', shadow: 'md', gridCols: 3, spacing: 'comfortable', animationLevel: 'smooth'
    }
  };
};
