...
const nextConfig = {
  ...
  async headers() {
    return [
        ...
        headers: [
          ...
          // MED-8 Fix: Content Security Policy
          {
            ...
            value: [
              ...
              "font-src 'self' data: https://bdretailers.com https://www.bdretailers.com https://fonts.gstatic.com",
      ...
      // ✅ Agent Engine Optimization (AEO) & Design System Markdown headers
      {
        source: '/DESIGN.md',
        headers: [
